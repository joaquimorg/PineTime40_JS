//{
    ...
    let ui_Clock01_StepsPanel;
    let ui_Clock01_imgWalk;
    let ui_Clock01_StepCount;
    let ui_Clock01_HRPanel;
    let ui_Clock01_imgHeart;
    let ui_Clock01_HRCount;
    let ui_Clock01_MsgPanel;
    let ui_Clock01_HasMsg;
    ...
    let ui_Config_Button4;
    let ui_Config_Label3;
    let ui_Config_Button5;
    let ui_Config_Label7;
    let ui_BottomInfo;
    let ui_Config_Time;
    let ui_Config_Batt_Icon;
    let ui_ConfigBatt;
    ...
    let drawClock = function() {
      ...
      lv.lv_label_set_text(ui_Clock01_StepCount, steps);
