...
ui_Clock01_Seconds = lv.lv_arc_create(ui_Clock01_Panel);
lv.lv_obj_clear_flag( ui_Clock01_Seconds, lv.LV_OBJ_FLAG_CLICKABLE | lv.LV_OBJ_FLAG_PRESS_LOCK | lv.LV_OBJ_FLAG_CLICK_FOCUSABLE | lv.LV_OBJ_FLAG_SNAPPABLE | lv.LV_OBJ_FLAG_SCROLLABLE | lv.LV_OBJ_FLAG_SCROLL_ELASTIC | lv.LV_OBJ_FLAG_SCROLL_MOMENTUM | lv.LV_OBJ_FLAG_SCROLL_CHAIN );    /// Flags

lv.lv_arc_set_range(ui_Clock01_Seconds, 0,59);
lv.lv_arc_set_value(ui_Clock01_Seconds, date.getSeconds(), lv.LV_ANIM_OFF);
lv.lv_obj_set_width( ui_Clock01_Seconds, 215);
lv.lv_obj_set_height( ui_Clock01_Seconds, 215);
...
//lv.lv_obj_set_x( ui_Clock01_DatePanel, 0 );
//lv.lv_obj_set_y( ui_Clock01_DatePanel, 0 );
lv.lv_obj_set_align( ui_Clock01_DatePanel, lv.LV_ALIGN_LEFT_MID );
...
lv.lv_obj_set_style_bg_color(ui_Clock01_DatePanel, lv.lv_color_hex(0xE30800), lv.LV_PART_MAIN | lv.LV_STATE_DEFAULT );
...
lv.lv_obj_set_style_text_color(ui_Clock01_DateDay, lv.lv_color_hex(0xFFFFFF), lv.LV_PART_MAIN | lv.LV_STATE_DEFAULT );
...
lv.lv_obj_set_style_text_color(ui_Clock01_DateDayName, lv.lv_color_hex(0xFFFFFF), lv.LV_PART_MAIN | lv.LV_STATE_DEFAULT );
...
//lv.lv_obj_set_x( ui_Clock01_BlePanel, 0 );
//lv.lv_obj_set_y( ui_Clock01_BlePanel, 0 );
...
lv.lv_obj_set_align( ui_Clock01_PwrPanel, lv.LV_ALIGN_RIGHT_MID );
